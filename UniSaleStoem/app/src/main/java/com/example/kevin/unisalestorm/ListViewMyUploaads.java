...
public class ListViewMyUploaads extends BaseAdapter {
    ...
    public ListViewMyUploaads(Context context, List<ListHelper> listHelper, String username) {
        this.context = context;
        this.listHelper = listHelper;
        inflater = LayoutInflater.from(context);
        this.arraylist = new ArrayList<ListHelper>();
        this.arraylist.addAll(listHelper);
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(context, myUploadSingleList.class);
                // Pass all data rank
